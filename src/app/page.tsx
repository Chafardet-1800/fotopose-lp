    ...
    <div className="flex flex-col min-h-screen items-center justify-center font-sans">
      ...
      <footer className="w-full px-10 pb-30 flex justify-between">
        ...
        <div className="flex flex-col gap-5">
          ...
          <h2 className="text-lg text-black/65 dark:text-white/65 ">
        ...
        <div className="flex justify-end gap-5 px-20">
          ...
          <ul className="flex flex-col gap-3">
            <li>
              <p className="font-bold pb-5">Cursos</p>
            </li>
            <li>
              <Link href="/course?type=aesthetics">
                <span className="text-sm font-semibol hover:text-red-800">
                  Belleza
                </span>
              </Link>
            </li>
          ...
          <ul className="flex flex-col gap-3">
            <li>
              <p className="font-bold pb-5">Servicios</p>
            </li>
            <li>
              <Link href="/course?type=aesthetics">
                <span className="text-sm font-semibol hover:text-red-800">
          ...
          <ul className="flex flex-col gap-3">
            <li>
              <p className="font-bold pb-5">Ayuda</p>
            </li>
            <li>
              <Link href="/course?type=aesthetics">
                <span className="text-sm font-semibol hover:text-red-800">
